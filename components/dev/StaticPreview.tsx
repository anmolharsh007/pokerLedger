...
const createStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    title: { fontSize: theme.font.size.xl, fontWeight: theme.font.weight.bold, color: theme.colors.textPrimary },
    backText: { fontSize: theme.font.size.lg, color: theme.colors.accent, fontWeight: theme.font.weight.bold },
    exitText: { color: theme.colors.danger, fontWeight: theme.font.weight.bold },
    list: { padding: 20, gap: 16 },
    notice: { fontSize: theme.font.size.xs, color: theme.colors.textSecondary, textAlign: 'center' },
