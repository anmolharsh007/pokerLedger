...
const createStyles = (theme: Theme) =>
  StyleSheet.create({
    ...
    deleteBtnText: { color: '#fff', fontWeight: theme.font.weight.bold, fontSize: 12 },
    playerName: { fontSize: theme.font.size.md, fontWeight: theme.font.weight.bold, color: theme.colors.textPrimary, textAlign: 'center' },
    tapHint: { fontSize: theme.font.size.xs, color: theme.colors.textSecondary, fontStyle: 'italic' },
    chipsSet: { flexDirection: 'row', alignItems: 'center', gap: 6 },
    chipsSetValue: { fontSize: theme.font.size.lg, fontWeight: theme.font.weight.bold, color: theme.colors.accent },
    untilNowBox: {
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    untilNowLabel: { fontSize: theme.font.size.xs, color: theme.colors.textSecondary },
    untilNowValue: { fontWeight: theme.font.weight.medium, color: theme.colors.textPrimary },
    modalIconRow: { alignItems: 'center' },
    modalTitle: { fontSize: theme.font.size.lg, fontWeight: theme.font.weight.bold, color: theme.colors.textPrimary, textAlign: 'center' },
